        ...
        try:
            ...
            for i in range(len(old_numbers_sort_str)):
                ...
                while "- " in old_numbers_sort_str[i]:
                    old_numbers_sort_str[i] = old_numbers_sort_str[i].replace(
                        "- ", "-", 1
                    )
                ...
                if len(split_num_lst) == 2:
                    ...
                    if len(split_num_lst[0].split("/")) == 1:
                        if len(split_num_lst[0].split(".")) == 1:
                            ...
                            if number[0] != "-":
                                chisl_desut_drob = str(split_num_lst[0]).replace(
                                    ".", "", 1
                                )
                                znam_desut_drob = 1
                                for j in range(
                                        len(str(split_num_lst[0].split(".")[1]))
                                ):
                                    znam_desut_drob *= 10
                                old_numbers_sort_lst[i] = [
                                ...
                                znam_desut_drob = 1
                                for j in range(
                                        len(chisl_desut_drob.replace("-", "", 1))
                                ):
                                    znam_desut_drob *= 10
                                old_numbers_sort_lst[i] = [
...
if __name__ == "__main__":
    ...
    start_handler = CommandHandler("start", start, has_args=False)
